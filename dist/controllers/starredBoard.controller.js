...
exports.toggleFavorite = exports.getFavoriteBoards = void 0;
...
const getFavoriteBoards = async (req, res) => {
    try {
        ...
        const favorites = await board_model_1.Board.find({
            createdBy: userId,
            isFavorite: true
        })
...
exports.getFavoriteBoards = getFavoriteBoards;
/**
...
//# sourceMappingURL=starredBoard.controller.js.map